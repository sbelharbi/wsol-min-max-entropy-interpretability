...
# You can omit this line if you do not use virtual environment wrapper. You can create your virtual environement
...
# mkvirtualenv -r requirements.txt pytorch.1.0.1
