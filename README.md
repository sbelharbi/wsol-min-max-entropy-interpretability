# Pytorch nightly build 1.2.0.dev20190616 (https://download.pytorch.org/whl/nightly/cu100/torch_nightly-1.2.0.dev20190616-cp37-cp37m-linux_x86_64.whl) code for: Weakly Supervised Object Localization using Min-Max Entropy: an Interpretable Framework
...
# Coming soon:
* Results over entire `Caltech-UCSD Birds-200-2011`.
* Results with CRF post-processing.
...
To be able to use it, first install the package. Then, you can use the class: `tools.CRF()`. Read its documentation 
for more details.
